...
const PersonnelActivitiesTableElm = ({
  ...
  return (
    <>
      <div className=' hidden sm:flex justify-start bg-slate-100 dark:bg-meta-4 border-b hover:[&>div]:bg-slate-400 hover:[&>div]:text-white'>
      ...
      {personnel.map((item, key) => (
        <div
          className={`flex-col sm:flex-row hover:bg-slate-200 dark:hover:bg-slate-700 flex justify-start ${
